...
class BootStrap {
    ...
    def init = { servletContext ->
    	...
    	def event1 = new Event(name: 'Gateway Code Camp', 
    							city: 'Saint Louis, MO', 
    							organizer: User.findByFullName('John Doe'), 
    							venue: 'TBD', 
		...
		def event2 = new Event(name: 'Perl Before Swine', 
								city: 'Austin, MN', 
								organizer: User.findByFullName('John Deere'), 
								venue: 'SPAM Museum', 
		...
		def g1 = Event.findByName('Gateway Code Camp') 
		g1.addToVolunteers(new User(fullName: 'Sarah Martin', 
									userName: 'sarah', 
									password: '54321', 
									email: 'sarah@martinworld.com', 
									website: 'www.martinworld.com', 
									bio: 'Web designer and Grails afficianado.')) 
		g1.addToVolunteers(new User(fullName: 'Bill Smith', 
									userName: 'Mr_Bill', 
									password: '12345', 
