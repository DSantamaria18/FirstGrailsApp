			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="event-label" class="property-label"><g:message code="task.event.label" default="Event" /></span>
						...
						<span class="property-value" aria-labelledby="event-label"><g:link controller="event" action="show" id="${taskInstance?.event?.id}">${taskInstance?.event?.encodeAsHTML()}</g:link></span>
