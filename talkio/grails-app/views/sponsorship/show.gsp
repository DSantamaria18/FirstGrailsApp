			...
			<ol class="property-list sponsorship">
				...
				<li class="fieldcontain">
					<span id="event-label" class="property-label"><g:message code="sponsorship.event.label" default="Event" /></span>
						...
						<span class="property-value" aria-labelledby="event-label"><g:link controller="event" action="show" id="${sponsorshipInstance?.event?.id}">${sponsorshipInstance?.event?.encodeAsHTML()}</g:link></span>
