<%@ page import="com.talkio.Sponsorship" %>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'event', 'error')} required">
	...
	<g:select id="event" name="event.id" from="${com.talkio.Event.list()}" optionKey="id" required="" value="${sponsorshipInstance?.event?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: sponsorshipInstance, field: 'sponsor', 'error')} required">
	...
	<g:select id="sponsor" name="sponsor.id" from="${com.talkio.Sponsor.list()}" optionKey="id" required="" value="${sponsorshipInstance?.sponsor?.id}" class="many-to-one"/>
